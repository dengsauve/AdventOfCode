addresses = "dnwtsgywerfamfv[gwrhdujbiowtcirq]bjbhmuxdcasenlctwgh
...
# looking for matches to this pattern
pattern_1 = /([a-z])((?!\1)[a-z])\2\1/

# If pattern_1 matched - filter out the results with this pattern
pattern_2 = /\[[a-z]*([a-z])((?!\1)[a-z])\2\1[a-z]*\]/

count = 0

addresses.each do |address|
  if pattern_1.match(address) && !pattern_2.match(address)
    count += 1
  end
end
